...
public class HistoriaacademicaServiceImpl implements HistoriaacademicaService {
    ...
    public Page<Historiaacademica> findAllWithEagerRelationships(Pageable pageable) {
        return historiaacademicaRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<Historiaacademica> findOne(Long id) {
        ...
        return historiaacademicaRepository.findOneWithEagerRelationships(id);
    }
